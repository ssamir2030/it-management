...
import { MapPin, Users, Monitor, Building } from "lucide-react"
...
export function LocationStats({ totalLocations, totalEmployees, totalAssets }: LocationStatsProps) {
    const stats = [
        {
        ...
        {
            title: "متوسط الأصول/موقع",
            value: totalLocations > 0 ? Math.round(totalAssets / totalLocations) : 0,
            icon: Building,
