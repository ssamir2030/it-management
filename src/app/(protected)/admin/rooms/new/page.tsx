...
import { createMeetingRoom } from '@/app/actions/admin-rooms'
...
export default function NewRoomPage() {
    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        const result = await createMeetingRoom(formData)

        if (result.success) {
            toast.success('تم إنشـاء القاعة بنجاح', {
                description: 'تم إضافة القاعة الجديدة إلى النظام'
            })
            router.push('/admin/rooms')
        } else {
            toast.error(result.error || 'فشل في إنشاء القاعة')
        }
    ...
    return (
        <div className="w-full py-10" dir="rtl">
            <PremiumPageHeader
                ...
                description="أدخل تفاصيل القاعة الجديدة وتجهيزاتها"
                icon={Layout}
                rightContent={
                    <Button variant="ghost" className="gap-2 text-white hover:bg-white/20" onClick={() => router.back()}>
                        ...
                        <CardContent className="space-y-4">
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <Input id="name" name="name" required placeholder="مثال: قاعة الاجتماعات الرئيسية" className="h-12 text-base" />
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="nameEn" className="text-base font-medium">اسم القاعة (إنجليزي)</Label>
                                    <Input id="nameEn" name="nameEn" placeholder="Example: Main Meeting Room" className="h-12 text-base" dir="ltr" />
                                </div>
                            </div>
                            ...
                            <div className="grid md:grid-cols-3 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        <Input id="location" name="location" required placeholder="مثال: المبنى الرئيسي" className="h-12 text-base pl-10" />
                                        <MapPin className="absolute left-3 top-3.5 h-5 w-5 text-muted-foreground" />
                                    </div>
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="floor" className="text-base font-medium">الدور</Label>
                                    <Input id="floor" name="floor" placeholder="مثال: الدور الثاني" className="h-12 text-base" />
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="capacity" className="text-base font-medium">السعة (أشخاص) <span className="text-red-500">*</span></Label>
                                    <div className="relative">
                                        <Input id="capacity" name="capacity" type="number" min="1" required className="h-12 text-base pl-10" />
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea id="description" name="description" placeholder="وصف مختصر للقاعة..." className="min-h-[100px] text-base" />
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="card-elevated border-t-4 border-t-sky-500/20">
                        ...
                        <CardContent className="grid gap-4">
                            <div className="flex items-center justify-between p-3 border rounded-xl hover:bg-muted/50 transition-colors">
                                ...
                                <Switch id="hasProjector" name="hasProjector" />
                            </div>
                            <div className="flex items-center justify-between p-3 border rounded-xl hover:bg-muted/50 transition-colors">
                                <div className="flex items-center gap-3">
                                    <Monitor className="h-5 w-5 text-muted-foreground" />
                                ...
                                <Switch id="hasScreen" name="hasScreen" />
                            </div>
                            <div className="flex items-center justify-between p-3 border rounded-xl hover:bg-muted/50 transition-colors">
                                <div className="flex items-center gap-3">
                                ...
                                <Switch id="hasVideoConf" name="hasVideoConf" />
                            </div>
                            <div className="flex items-center justify-between p-3 border rounded-xl hover:bg-muted/50 transition-colors">
                                <div className="flex items-center gap-3">
                                ...
                                <Switch id="hasSoundSystem" name="hasSoundSystem" />
                            </div>
                            <div className="flex items-center justify-between p-3 border rounded-xl hover:bg-muted/50 transition-colors">
                                <div className="flex items-center gap-3">
                                ...
                                <Switch id="hasWhiteboard" name="hasWhiteboard" />
                            </div>
                            <div className="flex items-center justify-between p-3 border rounded-xl hover:bg-muted/50 transition-colors">
                                <div className="flex items-center gap-3">
                                ...
                                <Switch id="hasWifi" name="hasWifi" defaultChecked />
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="card-elevated border-t-4 border-t-orange-500/20">
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="pt-4 border-t">
                                ...
                                <Textarea id="notes" name="notes" placeholder="ملاحظات خاصة للمسؤولين فقط..." className="min-h-[100px] text-base" />
                            </div>
                        </CardContent>
                    </Card>
